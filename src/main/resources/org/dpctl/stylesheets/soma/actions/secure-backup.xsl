...
<xsl:stylesheet
  ...
  <xsl:param name="include-iscsi" dpctl:doc="Include iSCSI [on|off]" dpctl:type="false"/>
  <xsl:param name="include-raid" dpctl:doc="Include RAID [on|off]" dpctl:required="false"/>
